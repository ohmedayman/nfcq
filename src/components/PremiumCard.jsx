...
export default function PremiumCard() {
  ...
  return (
    <div className="premium-card-container" onClick={() => setFlipped(!flipped)}>
      <div className={`premium-card-inner ${flipped ? 'flipped' : ''}`}>
        
        {/* Front of Card */}
        <div className="premium-card-front">
          <div className="pc-lines"></div>
          <div className="pc-header">
            <div className="pc-logo">
              <span className="pc-lamsa-text">Lamsa</span>
              <svg className="pc-nfc-wave" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
                <path d="M3 8C10 8 16 14 16 21" />
                <path d="M7 8C11.5 8 15 11.5 15 16" />
                <path d="M11 8c3 0 5 3 5 6" />
              </svg>
            </div>
            <div className="pc-title">Premium Card</div>
          </div>
          
          <div className="pc-footer">
            <div className="pc-qr-wrapper">
              ...
              <div className="pc-link">lamsa.ink</div>
            </div>
          </div>
        </div>
        ...
        <div className="premium-card-back">
          ...
          <div className="pc-back-footer">
            <div className="pc-back-link">lamsa.ink</div>
            <div className="pc-back-icon">
